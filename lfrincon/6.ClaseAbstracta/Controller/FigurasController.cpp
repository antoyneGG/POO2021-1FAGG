...
void FigurasController::agregarTriangulo(float base, float radio)
{
    if (listaTriangulo.size() < MAX_ITEMS)
    {
        cout << "Agrego triangulo" << endl;
        Triangulo *ptrianguloTemp = new Triangulo(base, radio);
...
void FigurasController::llenarListaTodosDummy()
{
    ...
    Triangulo *pMiTriangulo = new Triangulo(10, 15);
    Cuadrado *pMiCuadrado = new Cuadrado(8);
    int arreglo[10];
